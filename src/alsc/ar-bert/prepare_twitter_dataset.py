...
from utils import semeval2014term_to_aspectsentiment_hr, twitterterm_to_aspectsentiment_hr
...
for fn in args.files:
    ...
    # for twitter dataset
    sents_train, ats_train, idx2labels = twitterterm_to_aspectsentiment_hr(fn)
